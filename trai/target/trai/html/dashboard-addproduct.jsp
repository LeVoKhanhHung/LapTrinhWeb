...
<style>
	...
	<link rel="stylesheet" href="../css/listeo/css/main-color.css">
	<!--	<link rel="stylesheet" href="listeo/css/style.css">-->
<!--	<link rel="stylesheet" href="listeo/css/main-color.css">-->
			...
			<div class="dashboard-nav">
				<div class="dashboard-nav-inner">
					...
					<ul data-submenu-title="Products">
						...
						<li class="active"><a th:href="@{/dashboard-addproduct}"><i
					...
					<ul data-submenu-title="">
						<li><a href="index.jsp" ><i class="im im-icon-Home" ></i>
							...
							<div id="add-listing">
								...
								<div class="add-listing-section">
									...
									<div class="add-listing-headline">
										<h3>
											<i class="sl sl-icon-doc"></i> Basic Information
										</h3>
									</div>
