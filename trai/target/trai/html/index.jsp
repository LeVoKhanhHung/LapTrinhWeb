    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="our-link">
                    <ul>
                        <li><a href="my-profile.jsp"><i class="fa fa-user s_color"></i> Tài khoản</a></li>
    ...
    <ul class="slides-container">
        <li class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="m-b-20"><strong>Chào Mừng Đến <br> Trái Cây Nhập Khẩu FreshShop </strong></h1>
