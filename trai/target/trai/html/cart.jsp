                            ...
                            <tbody>
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
									<img class="img-fluid" src="../images/nho-xanh-nhap-khau-uc.jpeg" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="coupon-box">
                        <div class="input-group input-group-sm">
                            <input class="form-control" placeholder="Nhập Mã Giảm Giá" aria-label=" Nhập Mã Giảm Giá" type="text">
            ...
            <div class="row my-5">
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="order-box">
                        ...
                        <div class="d-flex">
                            <h4>Tổng</h4>
                            <div class="ml-auto font-weight-bold"> 250.000</div>
                        </div>
                        <div class="d-flex">
                            <h4>Gỉam</h4>
                        ...
                        <div class="d-flex">
                            <h4>Thuế</h4>
                            <div class="ml-auto font-weight-bold">  2.000 </div>
                        </div>
                        <div class="d-flex">
                            <h4>Shipping Cost</h4>
                            <div class="ml-auto font-weight-bold"> 100.000 </div>
                        </div>
                        <hr>
                        <div class="d-flex gr-total">
                            <h5>Tổng hóa đơn</h5>
                            <div class="ml-auto h5"> 388.000</div>
                        </div>
                        <hr> </div>
                </div>
                <div class="col-12 d-flex shopping-box"><a href="checkout.jsp" class="ml-auto btn hvr-hover">Kiểm tra</a> </div>
            </div>
