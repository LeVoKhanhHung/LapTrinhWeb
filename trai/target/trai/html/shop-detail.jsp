    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="our-link">
                    <ul>
                        <li><a href="my-profile.jsp"><i class="fa fa-user s_color"></i> Tài khoản của tôi</a></li>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    ...
                    <li class="nav-item"><a class="nav-link" href="contact-us.jsp">Liên hệ với chúng tôi</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
            ...
            <div class="login-box" style="font-weight: 700; font-size: 16px; text-transform: uppercase;">
                <div id=" basic" class="selectpicker show-tick form-control" data-placeholder="Sign In">
                    <a href="login.jsp">Đăng nhập</a><i class="fa-solid fa-right-to-bracket"></i>
                </div>
            </div>
                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="../images/nho-xanh-nhap-khau-uc.jpeg" alt="First slide"> </div>
...
<!--                                <img class="d-block w-100 img-fluid" src="../images/nho-xanh-nhap-khau-uc.jpeg" alt="" />-->
<!--                            </li>-->
<!--&lt;!&ndash;                            <li data-target="#carousel-example-1" data-slide-to="1">&ndash;&gt;-->
<!--&lt;!&ndash;                                <img class="d-block w-100 img-fluid" src="../images/smp-img-02.jpg" alt="" />&ndash;&gt;-->
<!--&lt;!&ndash;                            </li>&ndash;&gt;-->
<!--&lt;!&ndash;                            <li data-target="#carousel-example-1" data-slide-to="2">&ndash;&gt;-->
<!--&lt;!&ndash;                                <img class="d-block w-100 img-fluid" src="../images/smp-img-03.jpg" alt="" />&ndash;&gt;-->
<!--&lt;!&ndash;                            </li>&ndash;&gt;-->
<!--                        </ol>-->
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        <h2>Nho Mĩ</h2>
                        <h5> <del> 150.000đ</del> 100.000đ</h5>
                        <p class="available-stock"><span> mua trên 1000kg / <a href="#">100 đã bán</a></span><p>
                        <h4>Mô tả:</h4>
                        <p>Nho Mĩ tươi được trồng tự nhiên không phun thuốc</p>
                            <li>
                        ...
                        <div class="price-box-bar">
                            <div class="cart-and-bay-btn">
                                <a class="btn hvr-hover" data-fancybox-close="" href="cart.jsp">Mua</a>
                    ...
                    <div class="card-body">
                        <div class="media mb-3">
                            ...
                            <div class="media-body">
                                <p>Sản phẩm vẫn còn rất tươi bán rất chạy tôi đã mua rất nhiều.Khách hàng của tôi cũng rất ưa chuộng sản phẩm này</p>
                                <small class="text-muted">Đăng ẩn danh</small>
                            </div>
                        </div>
                        <hr>
                        <div class="media mb-3">
