              ...
              <table class="table table-hover tm-table-small tm-product-table">
                <thead>
                  ...
                  <tr>
                    ...
                    <th scope="col">idCatergory/th>
                    <th scope="col">productDescription</th>
                    <th scope="col">supplierName</th>
                    <th scope="col">idRating</th>
                    <th scope="col">salePercent</th>
                ...
                <tr>
                  ...
                  <td><c:choose>
                    <c:when test="${not empty p.supplierName}">
                      <img class="tm-product-name" src="${pageContext.request.contextPath}/${p.supplierName}" alt="Hình ảnh sản phẩm">
                    </c:when>
                    <c:otherwise>
                      <img class="tm-product-name" src="${pageContext.request.contextPath}/${p.supplierName}" alt="Hình ảnh mặc định">
                    </c:otherwise>
                  </c:choose>
                  </td>
                  <td>${p.productName}</td>
